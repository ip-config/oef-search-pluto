...
class DataModelInstanceStore(DapInterface.DapInterface):
    @has_logger
    ...
    def constructQueryConstraintObject(self, dapQueryRepnLeaf: DapQueryRepn.DapQueryRepn.Leaf) -> SubQueryInterface:
        ...
        return DataModelInstanceStore.ConstraintProcessor(self, rowProcessor, dapQueryRepnLeaf.target_field_name)
